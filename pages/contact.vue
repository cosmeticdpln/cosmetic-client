    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div class="bg-white p-8 rounded-xl shadow-sm">
          <h2 class="text-2xl font-bold text-gray-900 mb-6">ارسال پیام</h2>
        ...
        <div>
          <div class="bg-white p-8 rounded-xl shadow-sm mb-8">
            <h2 class="text-2xl font-bold text-gray-900 mb-6">اطلاعات تماس</h2>
            <div class="space-y-4">
              ...
              <div class="flex items-start">
                ...
                <div class="mr-4">
                  <h3 class="text-lg font-semibold text-gray-900">تلفن</h3>
              ...
              <div class="flex items-start">
                ...
                <div class="mr-4">
                  <h3 class="text-lg font-semibold text-gray-900">ایمیل</h3>
                  <p class="text-gray-600">info@helmis.com</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <!-- Social Media -->
          <div class="bg-white p-8 rounded-xl shadow-sm">
            <h2 class="text-2xl font-bold text-gray-900 mb-6">شبکه‌های اجتماعی</h2>
...
useHead({
  title: 'تماس با ما - هلمیز',
  meta: [
    {
      name: 'description',
      content: 'تماس با هلمیز - ارتباط با ما برای پاسخگویی به سوالات و پیشنهادات شما'
    }
  ]
})
</script> 